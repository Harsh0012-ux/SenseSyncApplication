...
object JlResColors {
    ...
    val SensifyGreen = Color(0xFFDA1A1A)
    val SensifyGreen10 = Color(0xFF230E00)
    val SensifyGreen20 = Color(0xFF510500)
    val SensifyGreen30 = Color(0xFF75002F)
    val SensifyGreen40 = Color(0xFFAE1451)
    val SensifyGreen50 = Color(0xFFDA1A66)
    val SensifyGreen60 = Color(0xFFED136A)
    val SensifyGreen70 = Color(0xFFFF4590)
    val SensifyGreen80 = Color(0xFFFF7CFF)
    val SensifyGreen90 = Color(0xFFFFA2C7)
    val SensifyGreen95 = Color(0xFFFFC7DD)
    val SensifyGreen99 = Color(0xFFFFECF3)
