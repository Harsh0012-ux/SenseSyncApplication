package io.SenseSync.sensor.ui.pages.about
...
import io.SenseSync.sensor.ui.pages.about.sections.AboutCommunity
...
//            con = it,
                ...
                Text(
                    modifier = Modifier
                        .width(width = 300.dp)
                        .align(alignment = Alignment.CenterHorizontally),
                    text = "Hey, Thank you for downloading SenseSync",
...
//                )
                ...
                Text(
                    modifier = Modifier
                        .width(width = 300.dp)
                        .align(alignment = Alignment.CenterHorizontally),
                    text = "An Android Application Developed By Harsh And Vinayak",
                ...
                ElevatedButton(
                    ...
                    onClick = {
                        uriHandler.openUri("https://github.com/Harsh0012-ux")
                    }) {
                    Icon(
                ...
                ElevatedButton(
                    ...
                    shape = RoundedCornerShape(JlResDimens.dp16),
                    onClick = {
                        uriHandler.openUri("https://github.com/vsbeginner")
                    }) {
                    Text(
                        modifier = Modifier.weight(1f),
                        color = Color.White,
